# Phase 3 Synthesis Methods — PRISMA Items 13a–13f & GRADE Setup

## Dependencies
> Read `output/{theme}/phase-3.md` → `## Effect Measures` and `## Eligibility Criteria` to understand your outcome definitions and study grouping rules before writing synthesis methods.
...
1. **Item 13a: Studies Contributing to Each Synthesis**
   ...
   → Write to: `output/{theme}/phase-3.md` → `## Synthesis Methods` → `### 13a: Studies Contributing to Each Synthesis`
...
2. **Item 13b: Data Preparation and Transformation**
   ...
   → Write to: `output/{theme}/phase-3.md` → `## Synthesis Methods` → `### 13b: Data Preparation and Transformation`
...
3. **Item 13c: Methods for Tabulating and Displaying Non-Pooled Results**
   ...
   → Write to: `output/{theme}/phase-3.md` → `## Synthesis Methods` → `### 13c: Methods for Tabulating and Displaying Non-Pooled Results`
...
4. **Item 13d: Statistical Synthesis Methods**
   ...
   → Write to: `output/{theme}/phase-3.md` → `## Synthesis Methods` → `### 13d: Statistical Synthesis Methods`
...
5. **Item 13e: Methods for Exploring Heterogeneity**
   ...
   → Write to: `output/{theme}/phase-3.md` → `## Synthesis Methods` → `### 13e: Methods for Exploring Heterogeneity`
...
6. **Item 13f: Sensitivity Analyses**
   ...
   → Write to: `output/{theme}/phase-3.md` → `## Synthesis Methods` → `### 13f: Sensitivity Analyses`

7. **GRADE Setup (prerequisite for Phase 4 Item 22)**
   ...
   → Write to: `output/{theme}/phase-3.md` → `## GRADE Setup`
